<template>
  <div class="mt-2">
    <div style="background-color: #012b72">
      <div class="p-3">
        <div
          class="
            grid grid-cols-3
          ...
          "
        >
          <div class="text-center font-semibold cursor-pointer">
            <router-link class="cursor-pointer" to="/products">
              <img
                ...
                class="mx-auto"
              />
              <h6>Online Shopping</h6></router-link
            >
          </div>
          <div class="text-center font-semibold cursor-pointer">
            <img
